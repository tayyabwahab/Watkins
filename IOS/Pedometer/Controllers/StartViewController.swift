...
class StartViewController: UIViewController {
    ...
    private func getPedemoterControllerInstance() -> PedometerViewController? {
        if let pedometerVC = self.storyboard?.instantiateViewController(withIdentifier: "PedometerViewController") as? PedometerViewController {
            return pedometerVC
        }
        return nil
    }
