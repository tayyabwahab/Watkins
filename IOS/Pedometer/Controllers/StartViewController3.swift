...
class StartViewController3: UIViewController {
    ...
    private func getPedemoterControllerInstance() -> PedometerViewController3? {
        if let pedometerVC = self.storyboard?.instantiateViewController(withIdentifier: "PedometerViewController3") as? PedometerViewController3 {
            return pedometerVC
        }
        return nil
    }
    ...
    @IBAction func popViewController(_ sender: Any) {
        ...
        self.navigationController?.backToViewController(viewController: WelcomeRepresentationViewController2.self)
    }
}
